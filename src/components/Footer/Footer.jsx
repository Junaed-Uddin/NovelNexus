...
const Footer = () => {
  return (
    <div className="relative">
      <footer className="px-4 divide-y bg-gray-100 bottom-0 w-full">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3 flex sm:justify-center items-start">
            <Link
              to={"/"}
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              <h3 className="uppercase font-bold dark:text-gray-900">
                Community
              </h3>
              <ul className="space-y-1">
                <li>
            ...
            <div className="space-y-3">
              <div className="uppercase font-bold dark:text-gray-900">
                Social media
              </div>
